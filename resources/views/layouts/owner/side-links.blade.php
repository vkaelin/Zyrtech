<li>
    <a href="/dashboard/chefs"
        class="{{ Request::is('dashboard/chefs') ? 'text-green-400' : ''}} flex items-center px-4 py-2 hover:bg-gray-700">
...
<li>
    <a href="/dashboard/chefs/create"
        class="{{ Request::is('dashboard/chefs/create') ? 'text-green-400' : ''}} flex items-center py-2 pl-8 hover:bg-gray-700">
        <svg class="icon" viewBox="0 0 20 20">
            <path
...
<li>
    <a href="/dashboard/sets"
        class="{{ Request::is('dashboard/sets') ? 'text-green-400' : ''}} flex items-center px-4 py-2 hover:bg-gray-700">
        <svg class="icon" viewBox="0 0 20 20">
