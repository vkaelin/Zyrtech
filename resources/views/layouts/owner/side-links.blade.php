<li>
    <a href="/dashboard/chefs"
        class="{{ Request::is('dashboard/chefs') ? 'text-green-400' : ''}} flex items-center px-4 py-2 hover:bg-gray-800 lg:hover:bg-gray-700">
...
<li>
    <a href="/dashboard/chefs/create"
        class="{{ Request::is('dashboard/chefs/create') ? 'text-green-400' : ''}} flex items-center py-2 pl-8 hover:bg-gray-800 lg:hover:bg-gray-700">
        <svg class="icon" viewBox="0 0 20 20">
            <path
...
<li class="lg:mt-2">
    <a href="/dashboard/sets"
        class="{{ Request::is('dashboard/sets') ? 'text-green-400' : ''}} flex items-center px-4 py-2 hover:bg-gray-800 lg:hover:bg-gray-700">
        <svg class="icon" viewBox="0 0 20 20">
            <path d="M10 1l10 6-10 6L0 7l10-6zm6.67 10L20 13l-10 6-10-6 3.33-2L10 15l6.67-4z" />
        </svg>
        <span class="ml-2">Sets de produits</span>
    </a>
</li>
