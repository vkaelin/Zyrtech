<template>
  <div>
    <span
      class="inline-block text-xs italic text-green-500 mb-2"
      v-if="hasVoted"
    >Merci pour votre note !</span>
    <span
      class="inline-block text-xs italic text-green-500 mb-2"
      v-if="!hasVoted && !readonly"
    >Evaluez ce produit !</span>
...
<script>
import ZyrtechForm from '@/components/ZyrtechForm';
